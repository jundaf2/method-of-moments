...
figure(4);hold on;
plot(Delta_Gap_Arange,real(Zin_NumericalResultList),'-r','Linewidth',4);
plot(Delta_Gap_Arange,imag(Zin_NumericalResultList),'-b','Linewidth',4);
grid on;xlabel('Delta Gap Length');
set(gca,'fontsize',24);
legend('Real[Z_{in}]','Imag[Z_{in}]');
